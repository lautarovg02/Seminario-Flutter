  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        colorScheme:
            ColorScheme.fromSeed(seedColor: Color.fromARGB(255, 209, 192, 11)),
        useMaterial3: true,
      ),
      home: const MyHomePage(title: 'Flutter Demo Home Page Lautaro'),
    );
  }
}
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: SpeedDial(
        ...
        children: [
          SpeedDialChild(
            child: const Icon(Icons.plus_one, color: Colors.yellow),
            label: 'Increment',
            backgroundColor: Colors.blue,
